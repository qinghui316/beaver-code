...
export function AgentAccessControl(props: AgentAccessControlProps) {
  return <ScopedAgentAccessControl key={props.accessView?.scopeKey} {...props} />;
}

function ScopedAgentAccessControl({ accessView: view, onSelectAccess, onRefreshAccess }: AgentAccessControlProps) {
